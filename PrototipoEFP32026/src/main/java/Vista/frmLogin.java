...
public class frmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboOpciones.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Bancos", "Cuentas Corrientes", "Inventarios", "Seguridad", "Comercio", "Comisiones de ventas", "Planillas", "Final", " " }));
...
case "Comisiones de ventas":
    ...
    case "Final":
    try {
         MdiFinal menu = new MdiFinal(); //para entrar al modulo del E.F
        menu.setVisible(true);
        this.dispose();
    } catch (Exception e) {
        System.out.println(e);
