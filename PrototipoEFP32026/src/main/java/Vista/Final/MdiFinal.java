...
//creacion de mdiFinal junio 01 del 2026
 ...
 * @author macoh
 */
public class MdiFinal extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(MdiFinal.class.getName());
...
//Vista.Logistica.frmAyuda ventana = new Vista.Logistica.frmAyuda();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new MdiFinal().setVisible(true));
    }
